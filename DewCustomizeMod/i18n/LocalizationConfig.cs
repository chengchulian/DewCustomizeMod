    ...
    public static class LocalizationConfig
    {
        ...
        public static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            ["zh-CN"] = new()
            {
                ...
                ["label_shop_added_items"] = "商店增加物品数量",
                ...
                ["label_enable_world_reveal"] = "开启所有节点透视",
                ...
                ["label_enable_lucid_dream_embrace_mortality"] = "清醒梦 拥抱死亡",
                ["label_enable_lucid_dream_bon_voyage"] = "清醒梦 一路顺风",
                ["label_enable_lucid_dream_grievous_wounds"] = "清醒梦 剧痛伤口",
                ["label_enable_lucid_dream_the_darkest_urge"] = "清醒梦 极暗冲动",
                ["label_enable_lucid_dream_wild"] = "清醒梦 野性本能",
                ["label_enable_lucid_dream_mad_life"] = "清醒梦 疯狂生涯",
                ["label_enable_lucid_dream_sparkling_dream_flask"] = "清醒梦 泡影浮梦",
            },
            ["en-US"] = new()
            {
                ...
                ["label_shop_added_items"] = "Extra shop items",
                ...
                ["label_enable_lucid_dream_embrace_mortality"] = "Lucid Dream: Embrace Mortality",
                ["label_enable_lucid_dream_bon_voyage"] = "Lucid Dream: Bon Voyage",
                ["label_enable_lucid_dream_grievous_wounds"] = "Lucid Dream: Grievous Wounds",
                ["label_enable_lucid_dream_the_darkest_urge"] = "Lucid Dream: The Darkest Urge",
                ["label_enable_lucid_dream_wild"] = "Lucid Dream: Wild Instinct",
                ["label_enable_lucid_dream_mad_life"] = "Lucid Dream: Mad Life",
                ["label_enable_lucid_dream_sparkling_dream_flask"] = "Lucid Dream: Sparkling Dream Flask"
            }
        };

        public static string Get(string key)
        {
            var lang = DewSave.profile.language;
            if (!Translations.ContainsKey(lang)) lang = "en-US";
            if (Translations[lang].TryGetValue(key, out var value)) return value;
            return key;
        }
    }
}