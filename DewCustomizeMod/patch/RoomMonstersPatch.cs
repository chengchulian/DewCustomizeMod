...
public static class RoomMonstersPatch
{
    [HarmonyPatch(nameof(RoomMonsters.SpawnMonsters))]
    [HarmonyPrefix]
    public static bool SpawnMonstersPrefix(RoomMonsters __instance, SpawnMonsterSettings settings)
    {
        Debug.Log("RoomMonsters.SpawnMonsters Patch");
