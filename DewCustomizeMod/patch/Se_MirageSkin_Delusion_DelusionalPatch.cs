...
public class SeMirageSkinDelusionDelusionalPatch
{

    [HarmonyPrefix]
    [HarmonyPatch("VictimOntakenHealProcessor")]
    public static bool VictimOntakenHealProcessorPrefix(Se_MirageSkin_Delusion_Delusional __instance, ref HealData data,
